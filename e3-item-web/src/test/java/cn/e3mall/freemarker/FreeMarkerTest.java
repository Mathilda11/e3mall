...
public class FreeMarkerTest {
	...
	public void testFreeMarker() throws Exception {
		...
		//3、设置模板文件保存的目录
		configuration.setDirectoryForTemplateLoading(new File("C:/Develop/workspace/e3-item-web/src/main/webapp/WEB-INF/ftl"));
...
//		Writer out = new FileWriter(new File("D:/temp/JavaEE32/freemarker/hello.txt"));
		Writer out = new FileWriter(new File("c:/temp/freemarker/student.html"));
		//8、生成静态页面
